'use strict';
// Central Bank of Iceland exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbi';
...
/** Latest rate for one pair, e.g. getRate('USD', 'ISK', { apiKey }). */
